<template>
    <div id="inackodering" class="popup">
        ...
        <div class="text">
            ...
            <br>
            <p class="orange box">Boxplats 3300kr/mån för 9kvm<p>
